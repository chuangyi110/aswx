...
import com.lzdn.aswxmall.core.storage.TencentStorage;
...
public class TencentStorageTest {
    ...
    public void test() throws IOException {
        ...
        tencentStorage.store(new FileInputStream(test), testFile.length(), "image/png", "aswxmall.png");
        Resource resource = tencentStorage.loadAsResource("aswxmall.png");
        String url = tencentStorage.generateUrl("aswxmall.png");
