...
import com.lzdn.aswxmall.db.service.AswxmallKeywordService;
...
public class AdminKeywordController {
    ...
    @Autowired
    private AswxmallKeywordService keywordService;
    ...
    public Object list(String keyword, String url,
        ...
        List<AswxmallKeyword> keywordList = keywordService.querySelective(keyword, url, page, limit, sort, order);
        return ResponseUtil.okList(keywordList);
    }

    private Object validate(AswxmallKeyword keywords) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody AswxmallKeyword keyword) {
    ...
    public Object read(@NotNull Integer id) {
        AswxmallKeyword keyword = keywordService.findById(id);
        return ResponseUtil.ok(keyword);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody AswxmallKeyword keyword) {
        Object error = validate(keyword);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody AswxmallKeyword keyword) {
