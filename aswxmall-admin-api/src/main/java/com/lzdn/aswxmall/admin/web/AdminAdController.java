...
import com.lzdn.aswxmall.db.service.AswxmallAdService;
...
public class AdminAdController {
    ...
    private Object validate(AswxmallAd ad) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody AswxmallAd ad) {
    ...
    public Object read(@NotNull Integer id) {
        AswxmallAd ad = adService.findById(id);
        return ResponseUtil.ok(ad);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody AswxmallAd ad) {
        Object error = validate(ad);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody AswxmallAd ad) {
        Integer id = ad.getId();
        if (id == null) {
            return ResponseUtil.badArgument();
        }
