...
public class AdminIssueController {
    ...
    public Object list(String question,
        ...
        List<AswxmallIssue> issueList = issueService.querySelective(question, page, limit, sort, order);
        return ResponseUtil.okList(issueList);
    }

    private Object validate(AswxmallIssue issue) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody AswxmallIssue issue) {
    ...
    public Object read(@NotNull Integer id) {
        AswxmallIssue issue = issueService.findById(id);
        return ResponseUtil.ok(issue);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody AswxmallIssue issue) {
        Object error = validate(issue);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody AswxmallIssue issue) {
