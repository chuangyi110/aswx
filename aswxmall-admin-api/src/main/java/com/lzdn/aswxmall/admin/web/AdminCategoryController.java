...
import com.lzdn.aswxmall.admin.vo.CategoryVo;
import com.lzdn.aswxmall.core.util.ResponseUtil;
import com.lzdn.aswxmall.db.service.AswxmallCategoryService;
...
public class AdminCategoryController {
    ...
    public Object list() {
        ...
        List<AswxmallCategory> categoryList = categoryService.queryByPid(0);
        for (AswxmallCategory category : categoryList) {
            ...
            List<AswxmallCategory> subCategoryList = categoryService.queryByPid(category.getId());
            for (AswxmallCategory subCategory : subCategoryList) {
    ...
    private Object validate(AswxmallCategory category) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody AswxmallCategory category) {
    ...
    public Object read(@NotNull Integer id) {
        AswxmallCategory category = categoryService.findById(id);
        return ResponseUtil.ok(category);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody AswxmallCategory category) {
        Object error = validate(category);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody AswxmallCategory category) {
    ...
    public Object catL1() {
        ...
        for (AswxmallCategory category : l1CatList) {
