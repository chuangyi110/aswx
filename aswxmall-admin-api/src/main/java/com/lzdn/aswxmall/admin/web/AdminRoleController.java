...
import com.lzdn.aswxmall.admin.util.AdminResponseCode;
...
import com.lzdn.aswxmall.db.service.AswxmallPermissionService;
import com.lzdn.aswxmall.db.service.AswxmallRoleService;
...
public class AdminRoleController {
    ...
    @Autowired
    private AswxmallRoleService roleService;
    @Autowired
    private AswxmallPermissionService permissionService;
    @Autowired
    private AswxmallAdminService adminService;
    ...
    public Object list(String name,
        ...
        List<AswxmallRole> roleList = roleService.querySelective(name, page, limit, sort, order);
        return ResponseUtil.okList(roleList);
    }

    @GetMapping("/options")
    public Object options() {
        List<AswxmallRole> roleList = roleService.queryAll();
    ...
    public Object read(@NotNull Integer id) {
        AswxmallRole role = roleService.findById(id);
        return ResponseUtil.ok(role);
    }


    private Object validate(AswxmallRole role) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody AswxmallRole role) {
    ...
    @PostMapping("/update")
    public Object update(@RequestBody AswxmallRole role) {
        Object error = validate(role);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody AswxmallRole role) {
        ...
        List<AswxmallAdmin> adminList = adminService.all();
        for (AswxmallAdmin admin : adminList) {
    ...
    public Object updatePermissions(@RequestBody String body) {
        ...
        for (String permission : permissions) {
            AswxmallPermission AswxmallPermission = new AswxmallPermission();
            AswxmallPermission.setRoleId(roleId);
            AswxmallPermission.setPermission(permission);
            permissionService.add(AswxmallPermission);
        }
        return ResponseUtil.ok();
    }
