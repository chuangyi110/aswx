...
import com.lzdn.aswxmall.db.service.AswxmallBrandService;
...
public class AdminBrandController {
    ...
    public Object list(String id, String name,
        ...
        List<AswxmallBrand> brandList = brandService.querySelective(id, name, page, limit, sort, order);
        return ResponseUtil.okList(brandList);
    }

    private Object validate(AswxmallBrand brand) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody AswxmallBrand brand) {
    ...
    public Object read(@NotNull Integer id) {
        AswxmallBrand brand = brandService.findById(id);
        return ResponseUtil.ok(brand);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody AswxmallBrand brand) {
        Object error = validate(brand);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody AswxmallBrand brand) {
