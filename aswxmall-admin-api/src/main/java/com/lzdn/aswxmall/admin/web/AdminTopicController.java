...
public class AdminTopicController {
    ...
    public Object list(String title, String subtitle,
        ...
        List<AswxmallTopic> topicList = topicService.querySelective(title, subtitle, page, limit, sort, order);
        return ResponseUtil.okList(topicList);
    }

    private Object validate(AswxmallTopic topic) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody AswxmallTopic topic) {
    ...
    public Object read(@NotNull Integer id) {
        ...
        List<AswxmallGoods> goodsList = null;
    ...
    @PostMapping("/update")
    public Object update(@RequestBody AswxmallTopic topic) {
        Object error = validate(topic);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody AswxmallTopic topic) {
