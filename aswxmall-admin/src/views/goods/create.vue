  ...
  <div class="app-container">
    ...
    <el-card class="box-card">
      ...
      <el-dialog :visible.sync="specVisiable" title="设置规格">
        ...
        <el-form ref="specForm"  v-show="specType==0" :rules="rules" :model="specForm" status-icon label-position="left" label-width="100px" style="width: 400px; margin-left:50px;">
