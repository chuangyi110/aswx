...
import com.lzdn.aswxmall.wx.service.GetRegionService;
...
public class WxAddressController extends GetRegionService {
	...
	public Object list(@LoginUser Integer userId) {
		...
		List<AswxmallAddress> addressList = addressService.queryByUid(userId);
	...
	public Object detail(@LoginUser Integer userId, @NotNull Integer id) {
		...
		AswxmallAddress address = addressService.query(userId, id);
		if (address == null) {
	...
	private Object validate(AswxmallAddress address) {
	 ...
	 */
	@PostMapping("save")
	public Object save(@LoginUser Integer userId, @RequestBody AswxmallAddress address) {
		if (userId == null) {
			return ResponseUtil.unlogin();
		}
	 ...
	 */
	@PostMapping("delete")
	public Object delete(@LoginUser Integer userId, @RequestBody AswxmallAddress address) {
		if (userId == null) {
			return ResponseUtil.unlogin();
		}
