...
import com.lzdn.aswxmall.db.service.AswxmallCommentService;
...
import com.lzdn.aswxmall.wx.service.UserInfoService;
...
public class WxCommentController {
    ...
    private Object validate(AswxmallComment comment) {
     ...
     */
    @PostMapping("post")
    public Object post(@LoginUser Integer userId, @RequestBody AswxmallComment comment) {
        if (userId == null) {
    ...
    public Object list(@NotNull Byte type,
        ...
        List<AswxmallComment> commentList = commentService.query(type, valueId, showType, page, limit);

        List<Map<String, Object>> commentVoList = new ArrayList<>(commentList.size());
        for (AswxmallComment comment : commentList) {
