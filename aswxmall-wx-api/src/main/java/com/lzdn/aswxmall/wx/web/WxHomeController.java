...
import com.lzdn.aswxmall.wx.service.WxGrouponRuleService;
...
public class WxHomeController {
    ...
    @Autowired
    private AswxmallAdService adService;
    ...
    private List<Map> getCategoryList() {
        ...
        List<AswxmallCategory> catL1List = categoryService.queryL1WithoutRecommend(0, SystemConfig.getCatlogListLimit());
        for (AswxmallCategory catL1 : catL1List) {
            List<AswxmallCategory> catL2List = categoryService.queryByPid(catL1.getId());
            List<Integer> l2List = new ArrayList<>();
            for (AswxmallCategory catL2 : catL2List) {
                l2List.add(catL2.getId());
            }

            List<AswxmallGoods> categoryGoods;
            if (l2List.size() == 0) {
