...
import com.lzdn.aswxmall.wx.service.HomeCacheManager;
...
public class WxCatalogController {
    ...
    public Object index(Integer id) {
        ...
        // 当前一级分类目录
        AswxmallCategory currentCategory = null;
        if (id != null) {
        ...
        // 当前一级分类目录对应的二级分类目录
        List<AswxmallCategory> currentSubCategory = null;
    ...
    public Object queryAll() {
        ...
        //所有子分类列表
        Map<Integer, List<AswxmallCategory>> allList = new HashMap<>();
        List<AswxmallCategory> sub;
        ...
        // 当前一级分类目录
        AswxmallCategory currentCategory = l1CatList.get(0);
    ...
    public Object current(@NotNull Integer id) {
        // 当前分类
        AswxmallCategory currentCategory = categoryService.findById(id);
        if(currentCategory == null){
            return ResponseUtil.badArgumentValue();
        }
        List<AswxmallCategory> currentSubCategory = categoryService.queryByPid(currentCategory.getId());
